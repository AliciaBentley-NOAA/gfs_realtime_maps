...
cat > ${MAP_PATH}/gfs/${INITDATE}${CYC}/mslp/plot_gfs_mslp_3panel.py <<EOF
#!/bin/bash
#PBS -N gfs_mslp_plot
...
qsub ${MAP_PATH}/gfs/${INITDATE}${CYC}/mslp/plot_gfs_mslp_3panel.py
sleep 3
echo Submitted mslp plots job! 
...
cat > ${MAP_PATH}/gfs/${INITDATE}${CYC}/500Z/plot_gfs_500Z_3panel.py <<EOF
#!/bin/bash
#PBS -N gfs_500Z_plot
...
qsub ${MAP_PATH}/gfs/${INITDATE}${CYC}/500Z/plot_gfs_500Z_3panel.py
sleep 3
